...
function AboutPage() {
  return (
    <motion.div className="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8 dark:bg-[#1f1f1f] bg-white text-black dark:text-white pt-30 items-center">
      ...
      <div className="why-choose-me grid lg:grid-cols-2 grid-cols-1 gap-x-20">
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.3 }}
          className="why-choose-me-section-img max-w-[584px]"
        >
          <Image
