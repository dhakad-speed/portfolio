export default function Home() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#1f1f1f] text-white pt-30 items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-center justify-center">
        <div className="flex flex-col gap-y-20 lg:mr-15">
          <div className="intro-text-wrapper">
            <div className="intro-text text-3xl"> Hey There I'm</div>
        ...
        <div className="flex justify-self-center">
          <div className="hero-headline-block absolute lg:left-[10%]   lg:top-[469px] lg:right-0 lg:pt-23 md:top-[448px] md:left-5  top-[751px]  text-center left-[121px]">
